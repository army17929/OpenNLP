...
class label():
    ...
    def label(self,
        ...
        nlp = stanza.Pipeline(lang='en', processors='tokenize,sentiment', tokenize_no_ssplit=True,use_gpu=False)
        ...
        def majority_voting(df=df_average):
            ...
            df.to_csv(output_file_vote,mode='w')
