...
class Data_Mining():
    ...
    def query():
        ...
        # This place id represents for the United States
        place_id = "96683cc9126741d1"
        query = '"nuclear power" future  lang:en -is:retweet'
    ...
    def json_to_csv(json_file, csv_file):
        # Open and read the json file, which came from the API.
        with open(json_file, 'r') as file:
            tweets = json.load(file)

        # Move the information in the json file to the csv file.
        with open(csv_file, 'a', newline='', encoding='utf-8') as file:
            ...
            for tweet in tweets['data']:
                ...
                writer.writerow([tweets, query, author_id, created_at])
...
output_directory = r'/home/ohwang/Desktop/NLP_Github/Data_labeling'
